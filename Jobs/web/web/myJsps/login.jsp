<%-- 
    Document   : login
    Created on : 7 Nov, 2015, 12:06:44 PM
    Author     : pinaki ghosh
--%>
                            ...
                            <form>
                                ...
                                <div class="textbox-wrap">
                                    <div class="input-group">
                                        ...
                                        <input type="text" required="required" class="form-control" placeholder="Email" id="loginUsername">
                                    </div>
                                </div>
                                <div class="textbox-wrap">
                                    <div class="input-group">
                                        <span class="input-group-addon "><i class="fa fa-key"></i></span>
                                        <input type="password" required="required" class="form-control " placeholder="Password" id="loginPwd">
                                    </div>
                                </div>
                            </form>
                            <div class="forgot">
